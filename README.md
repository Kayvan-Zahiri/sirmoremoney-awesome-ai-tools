...
- [Motion](https://www.usemotion.com/) - AI calendar scheduling with AI Employee feature for task automation (2025). 💰
...
- [Reclaim.ai](https://reclaim.ai/) - Intelligent calendar protection with Travel Timezone feature and 500K+ users. 🆓/💰
- [Clockwise](https://www.clockwise.com/) - AI-powered calendar optimization for teams with flexible holds. 🆓/💰
- [Nyota.ai](https://www.nyota.ai/) - AI meeting assistant with automated CRM updates and action tracking. 💰
- [Fathom](https://fathom.video/) - Free AI meeting recording and transcription with highlights. 🆓
- [Clockify](https://clockify.me) - AI-enhanced project time tracking with team analytics. 🆓/💰
- [RescueTime](https://www.rescuetime.com/) - Automatic time tracking with AI insights and focus modes. 🆓/💰
- [Focus@Will](https://www.focusatwill.com/) - Neuroscience-based focus music with AI personalization. 💰
- [Trevor AI](https://trevor.app/) - AI task scheduling and daily planning with time-blocking. 💰
- [Timely](https://timelyapp.com/) - Automatic time tracking with AI memory and project tagging. 💰
- [Sunsama](https://sunsama.com/) - Mindful daily planner with time-blocking and calendar integrations. 💰
- [Morgen](https://morgen.so/) - Unified calendar with AI scheduling and task integration. 🆓/💰
- [Amie](https://amie.so/) - Beautiful calendar app with AI scheduling and team coordination. 💰
...
- [FLUX.2/Kontext](https://blackforestlabs.ai/) - State-of-the-art image models with multi-reference, 4MP resolution, pose control, and context-aware editing (Nov 2025). 🆓/💰
- [Nano Banana](https://ai.google.dev/) - Google's best AI image generator (Gemini 2.5 Flash Image) for speed and quality (2025). 🆓/💰
- [Recraft V3](https://recraft.ai/) - Professional design-focused generator with vector export, icons, and logos. 🆓/💰
- [ByteDance AI (Seedream/Seedance)](https://bytedance.com/) - High-quality image generator and multi-shot video creation platform. 🆓/💰
- [Stable Diffusion 3.5](https://stability.ai/stablediffusion) - Latest open-source image generation model with enhanced quality. 🆓
- [ComfyUI](https://github.com/comfyanonymous/ComfyUI) - Powerful node-based UI for Stable Diffusion with advanced workflows. 🆓
- [Ideogram 3.0](https://ideogram.ai/) - SOTA model for text rendering and typography with Magic Prompt (2025). 🆓/💰
- [Reve](https://reve.ai/) - AI art with superior prompt adherence and multi-image editing. 🆓/💰
...
- [Google Imagen 4](https://deepmind.google/technologies/imagen/) - Google's latest photorealistic image model. 💰
...
- [Figma AI](https://www.figma.com/) - Design platform with AI features, auto layout, and IPO plans (2025). 🆓/💰
- [Adobe Creative Suite AI](https://www.adobe.com/) - AI-enhanced creative tools with Sensei, Firefly, and generative fill. 💰
- [Canva AI](https://www.canva.com/) - Design platform with Magic Design, background remover, and AI features. 🆓/💰
...
- [Simplified AI](https://simplified.com/) - All-in-one AI platform for design, video, and content (2025). 🆓/💰
...
- [Mockup Photos](https://mockup.photos/) - AI-generated mockups with 8000+ templates. 🆓/💰
...
- [Looka](https://looka.com/) - AI logo maker with full brand kit and social assets. 🆓/💰
...
- [Grammarly](https://www.grammarly.com/) - Advanced grammar and style checker with GrammarlyGO AI and tone detection. 🆓/💰
- [Jasper](https://www.jasper.ai/) - AI content generation for marketing teams with brand voice and campaigns. 💰
- [Copy.ai](https://www.copy.ai/) - AI copywriting assistant with workflows and GTM AI platform. 🆓/💰
...
- [ProWritingAid](https://prowritingaid.com/) - Advanced writing editor with AI analysis and style suggestions. 🆓/💰
...
- [Notion AI](https://www.notion.so/product/ai) - AI writing, Q&A, and agentic workflows with GPT-5 integration (Nov 2025). 💰
- [Google Workspace Studio](https://workspace.google.com/studio) - No-code AI agent builder for enterprise automation (Dec 2025). 🆓/💰
...
- [DataRobot](https://www.datarobot.com/) - Automated machine learning platform with AI agentic systems and 10.0 release features. 💰
- [H2O.ai](https://www.h2o.ai/) - Open-source ML and AI platform with h2oGPT and Document AI. 🆓/💰
- [AutoML by Google Cloud](https://cloud.google.com/automl/) - Google's AutoML suite with Vertex AI and Gemini integration. 💰
- [Azure ML](https://azure.microsoft.com/en-us/services/machine-learning/) - Microsoft's ML service with prompt flow and model catalog. 💰
...
- [Dataiku](https://www.dataiku.com/) - Data science platform with AI agents and LLM Mesh (2025). 💰
- [PyCaret](https://pycaret.org/) - Low-code ML library for rapid experimentation with 30+ algorithms. 🆓
- [Auto-Sklearn 2.0](https://automl.github.io/auto-sklearn/) - Open-source AutoML with ensemble learning. 🆓

### 📈 Data Analysis & Visualization

- [Tableau](https://www.tableau.com/) - Data visualization with Einstein AI and Tableau Pulse for insights. 💰
- [Microsoft Power BI](https://powerbi.microsoft.com/) - Business analytics with Copilot AI, natural language Q&A (2025). 💰
...
- [Domo](https://www.domo.com/) - End-to-end AI platform with Domo.AI and magic ETL (2025). 💰
- [Qlik Predict](https://www.qlik.com/) - No-code predictive analytics with AutoML for business users (Oct 2025). 💰
...
- [Roboflow](https://roboflow.com/) - Computer vision platform with RF-DETR Seg, AutoML, and 100K+ datasets. 🆓/💰
- [Google Cloud Vision](https://cloud.google.com/vision/) - Image analysis API with Vertex AI and Gemini integration. 💰
- [Clarifai](https://www.clarifai.com/) - Computer vision platform with custom model training and LLM integration. 🆓/💰
- [Amazon Rekognition](https://aws.amazon.com/rekognition/) - AWS image analysis with face, text, and scene detection. 💰
- [Microsoft Computer Vision](https://azure.microsoft.com/en-us/services/cognitive-services/computer-vision/) - Azure vision API with Florence foundation model. 💰
- [Averroes.ai](https://averroes.ai/) - Production-ready visual inspection for manufacturing and quality control. 💰
- [Nanonets](https://nanonets.com/) - Document AI with powerful OCR, invoice processing, and automation. 🆓/💰
...
- [Suno v5](https://suno.ai/) - Leading AI music generator with Studio DAW, 12-stem editing, 44.1kHz audio, and 8-minute tracks (Sep 2025). 🆓/💰
- [Udio 2](https://udio.com/) - Professional AI music with advanced vocal control and 50M+ songs created. 🆓/💰
...
- [ElevenLabs](https://elevenlabs.io/) - Advanced voice synthesis with v3, Agents for conversational AI, and Reader app for text-to-speech (Nov 2025). 🆓/💰
- [Murf AI](https://murf.ai/) - AI voice generator with 120+ voices in 20+ languages. 💰
...
- [Rev](https://www.rev.com/) - Professional transcription with 99% accuracy and human review option. 💰
...
- [Play.ht](https://play.ht/) - Realistic AI voice generator with 900+ voices and voice cloning. 🆓/💰
...
- [Sora 2](https://openai.com/sora) - OpenAI's video & audio generation with synchronized dialogue, iOS app (Sep 2025). 💰
- [Google Veo 3.1](https://deepmind.google/technologies/veo/) - Latest video model with Ingredients-to-Video, native audio, and cinematic quality (Oct 2025). 💰
- [Runway Gen-4.5](https://runwayml.com/) - #1 rated video model with unprecedented motion quality and physics accuracy (Dec 2025). 🆓/💰
- [Kling AI 2.6 Pro](https://kling.ai/) - Advanced video with audio, dialogue, Avatars 2.0, and O1 Edit features (Dec 2025). 🆓/💰
- [MiniMax Hailuo](https://hailuo.ai/) - Fast high-dynamic video generation with improved motion. 🆓/💰
...
- [Alibaba Live Avatar](https://github.com/alibaba/live-avatar) - Real-time talking digital person from voice at 20 FPS (Dec 2025). 🆓
- [Wan 2.5](https://alibaba.com/) - Alibaba's next-gen video generation with native sound. 🆓/💰
...
- [GitHub Copilot](https://github.com/features/copilot) - AI pair programmer with coding agent, plan mode, and multi-file editing (Dec 2025). 💰
- [Cursor](https://cursor.sh/) - AI-first code editor valued at $29.3B with voice mode, agent features, and background coding (Dec 2025). 🆓/💰
- [Windsurf](https://windsurf.com/) - Codeium's AI coding assistant with Cascade agent and deep codebase understanding. 🆓/💰
- [Augment Code](https://augmentcode.com/) - Enterprise AI coding platform with 10M+ token context and code graph. 💰
- [Kiro](https://aws.amazon.com/kiro/) - AWS AI IDE with spec-driven development and automated testing. 🆓/💰
- [Qodo](https://www.qodo.ai/) - AI coding platform for code quality, testing, and review (formerly Codium). 🆓/💰
- [Zed](https://zed.dev/) - High-performance AI code editor with collaborative features and Rust foundation. 🆓
...
- [Jules](https://labs.google/jules) - Google's AI coding agent for automated development and bug fixes (Oct 2025). 🆓
- [Claude Code](https://anthropic.com/claude-code) - Anthropic's AI coding tool with plan mode, desktop app, and agentic workflows (Nov 2025). 💰
- [Gemini Code Assist](https://cloud.google.com/gemini/docs/codeassist) - Google's AI coding with 2M token context and enterprise features. 💰
- [Replit Ghostwriter](https://replit.com/site/ghostwriter) - AI coding in the browser with deployment. 💰
- [Codeium](https://codeium.com/) - Free AI code acceleration with 70+ IDE support and 1M+ developers. 🆓
...
- [Google Antigravity](https://developers.google.com/antigravity) - Agentic AI development platform with Gemini 3 (Nov 2025). 🆓/💰
...
- [Supabase AI](https://supabase.com/) - Backend platform with AI-powered SQL and database features. 🆓/💰
...
- [Perplexity AI](https://www.perplexity.ai/) - AI search with Comet browser, Patents beta, and Sora 2 Pro integration (Dec 2025). 🆓/💰
- [Perplexity Comet](https://www.perplexity.ai/comet) - AI-powered browser with agentic capabilities and DeepSearch (Android Dec 2025). 🆓/💰
- [ChatGPT Search](https://openai.com/chatgpt/search) - OpenAI's real-time web search with citations and shopping. 💰
- [Google AI Overview](https://ai.google/) - Google's AI-enhanced search with Gemini 3 and AI Mode. 🆓
...
- [Kagi](https://kagi.com/) - Premium AI search with FastGPT and no ads or tracking. 💰
...
- [GPT-5.1](https://openai.com/gpt-5-1) - OpenAI's flagship model with Instant and Thinking modes (Nov 2025). 💰
- [GPT-5](https://openai.com/gpt-5) - OpenAI's unified multimodal model with improved reasoning (Aug 2025). 💰
- [Claude (Opus 4.5, Sonnet 4.5, Sonnet 4, Haiku)](https://anthropic.com/claude) - Anthropic's model family for coding, agents, and reasoning (2025). 💰
- [Gemini 3](https://deepmind.google/gemini/) - Google's most intelligent model, #1 on LMArena with Deep Think mode (Nov 2025). 💰
- [Gemini 3 Deep Think](https://ai.google/gemini) - Advanced parallel reasoning for complex problems (Dec 2025). 💰
- [Grok 4/3](https://x.ai/) - xAI's flagship models with Think mode, DeepSearch, and image generation. 💰
- [o4-mini](https://openai.com/o4) - OpenAI's cost-efficient reasoning model. 💰
- [o3](https://openai.com/o3) - OpenAI's advanced reasoning model. 💰
- [GPT-4.1](https://openai.com/gpt-4-1) - OpenAI's refined GPT-4 with improved coding and instruction following. 💰

### 🔓 Open Source LLMs

- [Mistral (Large 3, Ministral, Small)](https://mistral.ai/) - Open-source models: 675B MoE Large, small multimodal Ministral, Apache 2.0 (2025). 🆓
- [DeepSeek (V3.2, R1)](https://deepseek.com/) - Open-source reasoning models matching GPT-5, MoE architecture (671B). 🆓
- [LLaMA 4 (Scout, Maverick)](https://ai.meta.com/llama/) - Meta's MoE models: 109B Scout (10M ctx), 400B Maverick multimodal. 🆓
- [Qwen 3 (VL-235B)](https://qwenlm.github.io/) - Alibaba's trillion-parameter hybrid with vision-language support. 🆓
- [GLM-4.5](https://github.com/THUDM/GLM-4) - Zhipu's 130B model, #2 on LMArena with MIT license. 🆓
- [Kimi K2](https://moonshot.cn/) - Moonshot AI's robust Chinese LLM with open research. 🆓
- [Gemma 3](https://ai.google.dev/gemma) - Google's lightweight open model with Gemma license. 🆓
- [Falcon 3](https://falconllm.tii.ae/) - Latest open-source LLM by TII with improved performance. 🆓
...
- [Hugging Face](https://huggingface.co/) - ML model hub with 1M+ models, datasets, and Inference Endpoints. 🆓/💰
...
- [Salesforce Einstein](https://www.salesforce.com/products/einstein/) - AI for CRM with Agentforce platform and Sales Cloud Einstein (2025). 💰
- [Meta Business AI](https://www.meta.com/) - AI assistant for ads, WhatsApp, and Messenger with campaign automation (Oct 2025). 🆓/💰
...
- [Marketo](https://www.marketo.com/) - Marketing automation with AI personalization and lead scoring. 💰
...
- [Unity ML-Agents](https://unity.com/products/machine-learning-agents) - AI for game development with reinforcement learning. 🆓
- [Unity AI](https://unity.com/products/ai) - Contextual AI assistance, Muse behaviors, and asset generation for Unity 6.2. 🆓/💰
...
- [NVIDIA ACE](https://www.nvidia.com/en-us/ai/) - AI-driven digital humans with speech, animation, and lip sync (2025). 💰
...
- [Zapier](https://zapier.com/) - Automation platform with AI agents, chatbots, and 8000+ app integrations. 🆓/💰
...
- [Base44](https://base44.com/) - AI app builder acquired by Wix for $80M with natural language development (Dec 2025). 🆓/💰
- [Microsoft Power Platform](https://powerplatform.microsoft.com/) - Low-code development with Copilot AI and 1000+ connectors. 💰
- [Google AppSheet](https://www.appsheet.com/) - No-code app development with AI and Gemini integration. 🆓/💰
- [Bubble](https://bubble.io/) - Visual programming with AI plugins and full-stack capabilities. 🆓/💰
- [Glide](https://www.glideapps.com/) - No-code app builder with AI components and spreadsheet backend. 🆓/💰
...
- [Lindy.ai](https://lindy.ai/) - No-code AI agent platform for custom task automation with 3000+ integrations. 🆓/💰
- [Lindy Build](https://lindy.ai/build) - Visual builder for AI agents with workflow automation. 🆓/💰
- [Intercom Fin](https://www.intercom.com/) - AI agent that learns from help centers for customer support with 50% resolution rate. 💰
...
- [Dialogflow](https://cloud.google.com/dialogflow) - Google's conversational AI platform with Vertex AI integration. 🆓/💰
...
- [Seldon](https://www.seldon.io/) - ML deployment and monitoring at scale. 🆓/💰
...
- [CrewAI](https://crewai.com/) - Framework for building role-based AI agent teams with enterprise features. 🆓/💰
- [AgentGPT](https://agentgpt.reworkd.ai/) - Browser-based autonomous AI agent creation with no setup. 🆓
- [AutoGen v0.4](https://github.com/microsoft/autogen) - Microsoft's framework for multi-agent AI with parallel execution and event-driven architecture. 🆓
...
- [Google AI Studio](https://makersuite.google.com/) - Test Google's Gemini 3 models.
